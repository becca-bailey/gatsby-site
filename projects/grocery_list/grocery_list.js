...
// 	list.innerHTML = "";
// 	for (item in object) {
// 		list.innerHTML = list.innerHTML + "<li><input type = 'checkbox' value = " + item + ">" + item + ": " + object[item] + "</input></li>"
// 	}
...
//     displayList.innerHTML += "<option value = '" + listName + "' >" + listName + "</option>"
...
// 	var listName = listTitle.innerHTML;
